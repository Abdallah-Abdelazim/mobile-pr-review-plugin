...
- `references/android.md`, `references/ios.md`, `references/kmp.md`, `references/engineering-excellence.md` - read directly by dispatched passes via their `Read` tool, given as absolute (or `${CLAUDE_PLUGIN_ROOT}`-relative) paths by `SKILL.md` — never pasted inline as excerpts
